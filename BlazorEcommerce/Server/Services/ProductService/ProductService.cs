    ...
    public class ProductService : IProductService
    {
        ...
        public async Task<List<Product>> FindProductsBySearchText(string searchText)
        {
            return await _context.Products
                   .Where(p => p.Title.ToLower().Contains(searchText.ToLower()) && p.Visible && !p.Deleted
        ...
        public async Task<ServiceResponse<Product>> UpdateProduct(Product product)
        {
            ...
            foreach (var variant in product.Variants)
            {
                ...
                if(dbVariant == null)
                {
                    variant.ProductType = null; // so entity framework won't automatically generate it
            ...
            await _context.SaveChangesAsync();
            return new ServiceResponse<Product> { Data = product }; //maybe it should be dbProduct????
        }
